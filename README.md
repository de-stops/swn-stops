...
This is a simple script to download all [SWN](http://stadtwerke-nordhausen.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
...
"700363","Nordhausen, A.-Nexö-Str.",10.811955,51.4992,""
```
